...
//  gameState = "playing";
   ...
   menuImg = loadImage("bg/cover.png");
   instructionImg = loadImage("bg/instruction.png"); 
   powerupPanelBG = loadImage("powerupPanel.png");
   
   coinImage = loadImage("powerups/25/coin.png");
   speedImage = loadImage("powerups/25/speed.png");
   starImage = loadImage("powerups/25/star.png");
   heartImage = loadImage("powerups/25/heart.png");
   forceantlionImage = loadImage("powerups/25/forceantlion.png");
   
   toolIcon1 = loadImage("powerups/40/speed.png");
   toolIcon2 = loadImage("powerups/40/forceantlion.png");
   toolIcon3 = loadImage("powerups/40/star.png");
   toolIcon4 = loadImage("powerups/40/heart.png");
...
class Antlion extends Object{
  ...
  Antlion(){
    ...
    antlionImage = loadImage("antlion.png");
  }
