<?php include('../../header.php'); ?>
	...
	<section id="project">
		...
		<article>
			...
			<li>
				<b>Interaction.</b> There are comboboxes that assign data dimensions to visual dimensions. 
			</li>
			<li>
			...
			<iframe src="//player.vimeo.com/video/97175943?title=0&amp;byline=0&amp;portrait=0" width="66%" height="350px" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
